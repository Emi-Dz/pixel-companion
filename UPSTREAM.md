...
**Dino character sprites by [Arks](https://arks.itch.io/dino-characters)**

Licensed for use under the terms provided on the asset page. The sprite sheets are used as-is, bundled under `windows/assets/sprites/Dino/`.
